<template>
	<view class="content">
		...
		<view class="tabs">
			<view @click="tabSwitch('all')" class="tab" :class="{'on': tabFocus === 'all'}">全部圈子</view>
			<view @click="tabSwitch('my')" class="tab" :class="{'on': tabFocus === 'my'}">我的圈子</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			getZones() {
				...
				if (this.tabFocus === 'all') {
					api.getQzList(this.page, (error, data) => {
						uni.hideLoading();
